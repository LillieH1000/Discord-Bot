...
class membercount(commands.Cog):
    ...
    async def member_count(self):
        ...
        townofsalemmemberchannel = townofsalemguild.get_channel(772878081907884072)
        charizmemberchannel = charizguild.get_channel(879526082154496012)
        worfmemberchannel = worfguild.get_channel(902396491321180170)
        lilliememberchannel = lillieguild.get_channel(932817405556690944)
